...
class QuestionRepository(BaseRepository[Table, C, I, E, U]):
    ...
    def CreateWithForm(self, entity: SchemaCreateDBQuestionsForm, db: TSession, auto_commit = False) -> int:
        return CreateQuestionsForm(db, entity, auto_commit=auto_commit)

    def CreateWithSections(self, entity: SchemaCreateDBQuestionsSection, db: TSession, auto_commit = False) -> int:
        return CreateQuestionsSection(db, entity, auto_commit=auto_commit)