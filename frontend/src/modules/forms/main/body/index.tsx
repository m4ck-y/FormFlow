...
const Body: React.FC = () => {
    return (
        <Flex justify="center" style={{ backgroundColor: "#faf9f8" }} className="h-screen">
      ...
      <CardBody>
            ...
            <Flex vertical className="max-w-[1024px] w-full">
                <Flex justify="right">
                    ...
                    <Select style={{ maxWidth: "190px" }} selectedKeys={new Set(["all"])}>
                        {options.map((option) => (
                    ...
                    <Flex align="center" gap={5} justify="center">
                        <Button isIconOnly radius="full"><SVG_List /></Button>
                        <Select style={{  }} startContent={<SVG_Filter />} selectedKeys={new Set(["date"])}>
                            {orders.map((option) => (
