...
const InfoGeneral: React.FC = () => {
    return (
        <>
        <span>Si cambias tu nombre, es posible que debas re-verificar para mantener tu verificación.<Link>Saber mas</Link>
        </span>
            <Input
                label="Nombre(s)"
                variant="bordered"
            ...
            <span>Agrega un enlace que se mostrar  en la parte superior de tu perfil</span>

            <Input
                label="Link"
                variant="bordered"
            />
            <Input label="Texto del link" variant="bordered" description="Personaliza cómo se mostrará tu enlace (opcional)" />
        </>
    );
};
