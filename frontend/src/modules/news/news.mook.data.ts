...
const mockNews: NewPost[] = [
  ...
  {
    id: "news-0",
    title: "El satélite mexicano NanoConnect-2, esta en orbita",
    author: { id: "a0", name: "MEXICO AEROESPACIAL" },
    ...
    date: new Date("2021-02-03").toISOString(),
    ...
    source: ENewsSource.MEXICO_AEROSPACE,
  },
  {
    id: "news-1",
